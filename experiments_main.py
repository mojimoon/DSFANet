...
def main():
    ...
    parser.add_argument("--run-id", default=datetime.now().strftime("%Y%m%d_%H%M%S"), help="Name for this run. To resume an existing run, provide the same run-id.")
    parser.add_argument("--steps", default="1,2,3,4,5,6,7", help="Comma-separated steps")
    parser.add_argument("--device", default="cpu", help="cpu or cuda")
    parser.add_argument("--datasets", default="", help="Comma-separated datasets")
    ...
    parser.add_argument("--natural-shift-size", type=int, default=0, help="Cap for each natural-shift dataset in step2; 0 means use --drift-subset-size.")
    ...
    parser.add_argument("--ensembles", default="voting,stacking,xgboost", help="Comma-separated ensemble types.")
