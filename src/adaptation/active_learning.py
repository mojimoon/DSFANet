...
class ActiveLearner:
    """Sample-selection metrics for drift-aware selective retraining."""
    ...
    def fit_train_stats(self, x_static, x_temporal):
        """Estimate mean/std for uncertainty metrics on training data."""
    ...
    def _get_probs_and_features(self, x_static, x_temporal):
        ...
        with torch.no_grad():
            ...
            features = (
                self.model.extract_features(x_static, x_temporal)
    ...
    def select_geometric_diversity(self, x_static, x_temporal, budget_ratio, iterations=20):
        """Approximate max-volume subset on feature-space Gram determinants."""
    ...
    def select_ensemble_hybrid(self, x_static, x_temporal, budget_ratio):
        ...
        pool_indices = self.select_ensemble_rank(
            x_static,
            x_temporal,
            budget_ratio=(n_pool / n_samples),
        )
